<template>
  <Dialog v-model:visible="dialogs.create.open" modal>
    <EventCreate :day="dialogs.create.day" :calendar-api="calendarApi"/>
  </Dialog>
  <Dialog v-model:visible="dialogs.edit.open" modal>
    <EventUpdate :event="dialogs.edit.event" :calendar-api="calendarApi"/>
  </Dialog>
...
const calendarOptions = useCalendarOptions(setCalendarApi, menu, fields, onDayClicked, onEventDropped, onEventClicked);
