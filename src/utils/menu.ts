...
export const menu = (router: any) => [
  {
    ...
    command: () =>
      router.push({ name: "Guide", query: { docs: "get-started" } }),
    items: [
      {
        label: "Get started",
      ...
      },
      {
        ...
        icon: "mdi mdi-help",
        command: () =>
          router.push({ name: "Guide", query: { docs: "how-to-use" } }),
      },
      {
        label: "Date & Time",
        icon: "mdi mdi-calendar-clock",
        command: () =>
          router.push({ name: "Guide", query: { docs: "date-time" } }),
      },
      {
        label: "Events customizing",
        icon: "mdi mdi-calendar-week-outline",
        command: () =>
          router.push({ name: "Guide", query: { docs: "events-customizing" } }),
      },
      {
        label: "Storing event data",
        icon: "mdi mdi-data-matrix",
        command: () =>
          router.push({ name: "Guide", query: { docs: "event-data" } }),
      },
      {
        label: "Drag & Resize",
        icon: "mdi mdi-clock",
        command: () =>
          router.push({ name: "Guide", query: { docs: "drag-resize" } }),
      },
      {
    ...
    items: [
      {
        ...
        icon: "mdi mdi-drag",
        command: () =>
          router.push({ name: "Demos", query: { docs: "draggable-events" } }),
      },
      {
        label: "Resizable events",
        icon: "mdi mdi-resize",
        command: () =>
          router.push({ name: "Demos", query: { docs: "resizable-events" } }),
      },
      {
        label: "Renderer",
        icon: "mdi mdi mdi-atom-variant",
        command: () =>
          router.push({ name: "Demos", query: { docs: "renderer" } }),
      },
      {
        label: "Event Template",
        icon: "mdi mdi-forest-outline",
        command: () =>
          router.push({ name: "Demos", query: { docs: "event-template" } }),
      },
      {
        label: "Time range",
        icon: "mdi mdi-clock-time-five-outline",
        command: () =>
          router.push({ name: "Demos", query: { docs: "time-range" } }),
      },
      {
        label: "Date range",
        icon: "mdi mdi-calendar-range",
        command: () =>
          router.push({ name: "Demos", query: { docs: "date-range" } }),
      },
      // {
      //     label:'Full demo',
      ...
      // },
      {
        ...
        command: () =>
          router.push({ name: "Demos", query: { docs: "month-view" } }),
      },
    ],
  },
  {
