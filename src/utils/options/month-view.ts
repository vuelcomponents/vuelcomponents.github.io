import type {IVuelCalendarApi, IVuelCalendarOptions, VuelCalendarOptions } from "vuelcalendar";

export const monthView = (setApi:(api:IVuelCalendarApi)=>void):VuelCalendarOptions => {
