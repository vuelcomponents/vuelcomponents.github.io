...
export const eventRenderer = (setApi:(api:IVuelCalendarApi)=>void, initialRenderer:string):IVuelCalendarOptions => {
        ...
        onVuelCalendarApiReady(api:IVuelCalendarApi) {
            ...
            api.setEvents([
                ...
                },
                {
                    ...
                    start: new Date(new Date(new Date().setHours(10, 0)).setDate(new Date().getDate() + 1)),
                    end: new Date(new Date(new Date().setHours(14, 0)).setDate(new Date().getDate() + 1)),
                },
            ])
        },
    }
