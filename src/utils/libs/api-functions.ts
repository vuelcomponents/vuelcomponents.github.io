const methods = [
    ...
    },
    {
        ...
        return:'void',
        code:'    api.setEventTemplate((event:VuelCalendarEvent)=>{\n' +
        ...
        description: 'This function changes the eventTemplate, a parameter responsible for substituting the HTML DOM tree into event elements instead of the default event backdrop.'
    },
...
const getFunctionsMenu = (router:any)=>{
    ...
    for(const func of methods){
        menu.push({
            ...
            command:()=>router.push({name:'ApiFunctions', query:{docs:func.call}})
        })
    }
    return menu;
}
