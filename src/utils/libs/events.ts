const events = [
  ...
  },
  {
    ...
    code:
      ...
      "    },",
    description:
      "Event returns the day that was clicked, along with the time and date on the timeline, as well as the events that belong to this day",
  },
  {
    id: 2,
    ...
    code:
      ...
      "    },",
    description:
      "Event returns the day that was double clicked, along with the time and date on the timeline, as well as the events that belong to this day",
  },
  {
    id: 3,
    ...
    code:
      ...
      "    },",
    description:
      "Event returns the event that was clicked, along with the time and date of start and end, as well as the data:any that belong to this event.",
  },
  {
    id: 4,
    ...
    code:
      ...
      "},",
    description:
      "[draggableEvents must be set to true in VuelCalendarOptions] Event returns the drop object(VuelCalendarEvent&VuelCalendarDay&MousEvent) that was being dragged, along with the time and date on timeline.",
  },
  {
    id: 5,
    ...
    code:
      ...
      "},",
    description:
      "[resizableEvents must be set to true in VuelCalendarOptions] Event returns the resize object that was being resized, along with old and new start datetime.",
  },
  {
    id: 6,
    ...
    code:
      ...
      "},",
    description:
      "[resizableEvents must be set to true in VuelCalendarOptions] Event returns the resize object that was being resized, along with old and new end datetime.",
  },
];

const getEventsMenu = (router: any) => {
  const menu = [];
  for (const event of events) {
    menu.push({
      ...
      command: () =>
        router.push({ name: "Events", query: { docs: event.event } }),
    });
  }
  return menu;
};
export { events, getEventsMenu };
