const params = [
  ...
  },
  {
    ...
    type: "Number",
    description:
      "Minimum 1, this parameter defines how many days after the start day should be displayed (including the first day)",
  },
  {
    id: 5,
    param: "startHour",
  ...
  },
  {
    ...
    code:
      ...
      "</template>",
    description:
      "Registered vue component to use as renderer for event container.",
  },
  {
    id: 15,
    param: "eventTemplate",
    ...
    code:
      ...
      "  }",
    description:
      "This is a function parameter where you can use the event object to match the DOM tree to your event object. It works similar to a renderer, but it uses HTML strings instead.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    code:
      ...
      "};\n",
    description:
      "Set if you want to implement resizable events -> onEventStartResized(resized:VuelCalendarResize) & onEventEndResized:(resized:VuelCalendarResize) -< then implement these methods to catch resized events on timeline",
  },
  {
    id: 10,
    param: "throwErrors",
  ...
  },
  {
    ...
    code: "vuelCalendarOptions: {\n" + "...\n" + "showCursorTime:true\n" + "}",
    description:
      "Set to true will display a small div with current time by cursor position",
  },
  {
    id: 13,
    param: "tresHold",
    ...
    type: "Number",
    description:
      "This parameter sets the threshold for the draggable event.\n" +
...
const getParamsMenu = (router: any) => {
  ...
  for (const param of params) {
    menu.push({
      ...
      command: () =>
        router.push({ name: "Params", query: { docs: param.param } }),
    });
  }
  return menu;
};
