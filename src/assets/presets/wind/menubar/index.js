export default {
  root: {
    class: [
      ...
      'ring-1 ring-inset ring-ultra-lightkamikaze dark:ring-surface-800 ring-offset-0'
    ]
  },
  menu: ({ props }) => ({
    class: [
  ...
  content: ({ props, context }) => ({
    class: [
      ...
      //  Colors
      {
        ...
        'text-surface-100  dark:text-surface-100 bg-ultra-100 dark:bg-black/70':
            context.focused && !context.active,
        'text-surface-50 dark:text-surface-50 bg-ultra-100 dark:bg-black/70':
            context.focused && context.active,
        'text-surface-50 dark:text-surface-50 bg-ultra-100 dark:bg-black/70':
            !context.focused && context.active
      },
      ...
      // Hover States
      {
        'hover:bg-primary-600 hover:text-surface-50 dark:hover:bg-surface-800': !context.active,
        'hover:bg-primary-500 hover:text-surface-100  dark:hover:bg-black/40 text-surface-900 dark:text-surface-0/80':
        context.active
      },
