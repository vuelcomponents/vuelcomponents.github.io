export default {
  root: ({ props, parent }) => ({
    class: [
      ...
      {
        'ring-1 ring-surface-700 dark:ring-surface-700 ring-offset-0':
  ...
  input: {
    root: ({ parent }) => ({
      class: [
        ...
        // Colors
        'text-surface-100 dark:text-surface-0',
        'placeholder:text-surface-400 dark:placeholder:text-surface-500',
        'bg-ultra-kamikaze dark:bg-surface-900',
        {
          'border-r border-surface-700 dark:border-surface-700':
            parent.props.showButtons && parent.props.buttonLayout == 'stacked'
        },
        {
          'border-x border-surface-700 dark:border-surface-700':
            parent.props.showButtons && parent.props.buttonLayout == 'horizontal'
        },
        {
          'border-y border-surface-700 dark:border-surface-700':
  ...
  incrementbutton: {
    root: ({ parent }) => ({
      class: [
        ...
        'bg-surface-kamiakaze dark:bg-surface-800',
        ...
        'hover:bg-surface-lightkamiakaze dark:hover:bg-surface-700',
