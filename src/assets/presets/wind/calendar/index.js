export default {
  ...
  input: ({ props }) => ({
    class: [
      ...
      // Colors
      'text-surface-10 dark:text-surface-0',
      ...
      // Shape
      'appearance-none w-full text- h-full text-right',
  ...
  dropdownbutton: {
    root: {
      class: [
        ...
        // Colors
        'text-surface-600 dark:text-ultra-lightkamikaze',
        'bg-ultra-lightkamikaze dark:bg-surface-800',
  ...
  panel: ({ props }) => ({
    class: [
      ...
      // Colors
      'bg-ultra-kamikaze dark:bg-surface-800',
      'ring-ultra-lightkamikaze dark:ring-surface-700',
  ...
  header: ({ props }) => ({
    class: [
      ...
      // Colors
      'text-surface-300 dark:text-white/80',
      'bg-ultra-kamikaze dark:bg-surface-800'
    ]
  }),
  previousbutton: ({ props }) => ({
    class: [
      ...
      // States
      'hover:text-surface-10 dark:hover:text-white/80',
  ...
  monthTitle: {
    class: [
      ...
      // Colors
      'text-surface-10 dark:text-white/80',
  ...
  tablebodyrow: {
    class: ['border-b border-surface-700 dark:border-surface-700 last:border-b-0']
  },
  weekheader: {
    class: [
  ...
  weeklabelcontainer: ({ context }) => ({
    class: [
      ...
      {
        'hover:bg-ultra-lightkamikaze dark:hover:bg-surface-800/80': !context.disabled
      },
      {
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      {
        'hover:bg-ultra-lightkamikaze dark:hover:bg-surface-600/80': !context.disabled,
  ...
  month: ({ context }) => ({
    class: [
      ...
      // States
      'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 dark:focus:ring-primary-400',
      'hover:bg-ultra-lightkamikaze dark:hover:bg-surface-600/80',
  ...
  timepicker: {
    class: [
      // Flexbox
      'flex',
      'justify-center items-center text-surface-300',
